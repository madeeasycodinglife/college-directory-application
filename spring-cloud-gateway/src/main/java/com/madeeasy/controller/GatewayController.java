...
public class GatewayController {
    ...
    @RequestMapping(path = "/department-service")
    public Mono<ResponseEntity<String>> departmentServiceFallBack() {
        return Mono.just(ResponseEntity
                .status(HttpStatus.SERVICE_UNAVAILABLE)
                .body("The Department Service is currently unavailable. Please try again later. If you need immediate help, please contact support at support@madeeasy.com."));
    }
    @RequestMapping(path = "/enrollment-service")
    public Mono<ResponseEntity<String>> enrollmentServiceFallBack() {
        return Mono.just(ResponseEntity
                .status(HttpStatus.SERVICE_UNAVAILABLE)
                .body("The Enrollment Service is currently unavailable. Please try again later. If you need immediate help, please contact support at support@madeeasy.com."));
    }

    @RequestMapping(path = "/profile-service")
    public Mono<ResponseEntity<String>> profileServiceFallBack() {
        return Mono.just(ResponseEntity
                .status(HttpStatus.SERVICE_UNAVAILABLE)
                .body("The Profile Service is currently unavailable. Please try again later. If you need immediate help, please contact support at support@madeeasy.com."));
    }
}