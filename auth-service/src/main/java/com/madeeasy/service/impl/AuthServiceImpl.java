...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse singUp(AuthRequest authRequest) {
        ...
        if (!normalizedRole.contains(Role.STUDENT.name()) && !normalizedRole.contains(Role.FACULTY_MEMBER.name()) && !normalizedRole.contains(Role.ADMINISTRATOR.name())) {
        ...
        // Now that we have the ID, we can build the UserRequest
        UserRequest userRequest = UserRequest.builder()
                .id(savedUser.getId())
                .fullName(authRequest.getFullName())
                .email(authRequest.getEmail())
                .password(user.getPassword()) // Ensure this is secure if sent over network
                .phone(authRequest.getPhone())
        ...
        // if service-is unavailable then remove the savedUser
